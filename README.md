...
Hap1 is more complete; Hap2 is slightly lower (expected in diploid assemblies)
________________________________________

Merqury (Reference-free)
•	Completeness: 99.9999%
•	Haplotype separation: Clear
Indicates near-perfect assembly with minimal errors
________________________________________
...
Correct contigs but unorganized

After Scaffolding:

•	Clear block structures

Each block represents a chromosome
